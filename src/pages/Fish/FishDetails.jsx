        ...
        <div className='flex flex-col justify-between lg:flex-row gap-16 lg:items-center'>
            ...
            <div className='flex flex-col gap-4 lg:w-2/4 text-left bubbist'>
                <div>
                    ...
                    <h1 className='text-3xl font-l'>Seer Fish / Vanjaram / Nei Meen</h1>
                </div>
                ...
                <div className='flex flex-row items-center gap-12'>
                    ...
                    <select className='bg-gray-200 py-2 px-4 rounded-lg text-black text-xl' value={cutType} onChange={(e) => setCutType(e.target.value)}>
                        <option value="Fresh">Fresh</option>
                        <option value="Slice">Slice</option>
                        <option value="Cubes">Cubes</option>
                        <option value="Cubes">Curry Cut</option>
                    </select>
